...
window.onload = function() {
    manifest = [
        {src: 'img/record.png', id: 'sona1'},
        {src: 'img/back.png', id: 'sona2'},
        {src: 'img/pause.png', id: 'sona3'},
        {src: 'img/next.png', id: 'sona4'},
...
$(function () {
    ...
    var Dom = {
        ...
        index: $("#pagePlaylist"),
        audio: $("#audio")[0], //Dom节点
        songContainerWrap: $(".playlist_wrap"),
...
//    工具类
    ...
    function main() {
        ...
        initModel.getSongList(HTTPrequest, function (data) {
            // 生成所有歌曲列表

            songListUI.renderList(data.payload.sounds, function () {
